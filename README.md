...
**Live App (Beta):** [https://aetria-breathein-tuneout.vercel.app/](https://aetria-breathein-tuneout.vercel.app/)
...
Aetria is and will always strive to be free — no paywalls, no locked features. But, keeping it that way means I have to make a choice. I could slap ads everywhere and call it a day or even worse, sell your data to bloodthirsty companies (OH NO!), but honestly? Ads are annoying, they clutter the experience and selling your data is downright evil, and they go against everything Aetria is supposed to be: a clean, focused space for you to actually get stuff done.

So, instead of bombarding you with ads or using your data, I'm keeping Aetria ad-free and leaving it up to you. If Aetria has been your productivity wingman, helped you focus a little better, or just made you feel slightly more in control of your chaos, consider supporting me. It helps me keep the lights on, keep improving the app, and most importantly, keep the ads out. No pressure at all. Even just using the app and sharing it with a friend means the world.

**Support via Polar:** (coming soon heheheheheh)
